...
echo "$Key" > $IVAR2
rm $HOME/lista-arq
wget --no-check-certificate -O /etc/SCRIPT/gerar.sh -q https://raw.githubusercontent.com/Waldo60/FASE1/main/Files-BOT.Open/SCRIPT/gerar.sh && chmod +x /etc/SCRIPT/gerar.sh
